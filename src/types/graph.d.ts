...
export interface Mutation {
  ...
  ReportMovement: ReportMovementReponse;
  RequestEmailVerification: RequestEmailVerificationResponse;
...
export type StatusOptions = "ACCEPTED" | "CANCELED" | "FINISHED" | "REQUESTING" | "ONROUTE";
...
export interface ReportMovementReponse {
  ok: boolean;
  error: string | null;
}
